...
fn main() {
    ...
    // prints whether the contents of the String are plural or singular.
    // Then uncomment and run this code with `cargo run apple` and `cargo run apples'.
    ...
    // indicating whether the String both starts with a "b" AND contains an "a".
